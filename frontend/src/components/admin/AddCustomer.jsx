...
import { UserPlus, Mail, Lock, User, Phone, MapPin, Eye, EyeOff, Building, ArrowLeft } from 'lucide-react';
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Add New Customer</h2>
            <p className="text-gray-600">Create a new customer account for your business</p>
          </div>
        </div>
